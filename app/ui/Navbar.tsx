                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                <Link href="/" className="rounded-md px-3 py-2 text-sm font-medium text-primary" aria-current="page">Home</Link>
                                <Link href="/recipes" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800  hover:text-primary">Recipes</Link>
                                <Link href="/signup" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800  hover:text-primary">Signup</Link>
                                <Link href="/about" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800  hover:text-primary">About</Link>
                            </div>
                        </div>
                    </div>
